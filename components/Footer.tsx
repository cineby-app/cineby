  ...
  return (
    <footer className="w-full bg-[#05050A] border-t border-[#1F2937]/60 pt-12 pb-12 px-6 md:px-16 lg:px-24 mt-auto relative z-20">
      <div className="max-w-7xl mx-auto flex flex-col space-y-10">
        ...
        {/* Exchange Backlinks Section */}
        <div className="flex flex-col items-center gap-3 py-2">
          <span className="text-[10px] uppercase tracking-[0.2em] text-gray-600 font-medium">Partner Sites</span>
          <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2">
            <a 
              href="https://www.mariniosiptv.vip/" 
              target="_blank" 
              className="text-[11px] text-gray-500 hover:text-[#b50000] transition-colors duration-300 tracking-wide"
            >
              Marinios IPTV
            </a>
            <a 
              href="https://www.zenoraiptv.live/" 
              target="_blank" 
              className="text-[11px] text-gray-500 hover:text-[#b50000] transition-colors duration-300 tracking-wide"
            >
              Zenora IPTV
