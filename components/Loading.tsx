...
/* =========================================================
   INNER LOGIC — uses useSearchParams (needs Suspense wrapper)
   ========================================================= */
function LoadingLogic() {
  ...
  useEffect(() => {
    ...
    // 6-Second recovery fallback (from your original file)
...
/* =========================================================
   MAIN EXPORT — wraps logic in Suspense (required by Next.js)
   ========================================================= */
